...
def test_nfp_window_blocked():
    ...
    dt = datetime(2025, 1, 10, 13, 30, 0, tzinfo=timezone.utc)  # NFP Jan 2025
...
def test_fomc_window_blocked():
    ...
    dt = datetime(2025, 1, 29, 19, 1, 0, tzinfo=timezone.utc)  # FOMC Jan 2025
    assert is_news_window(dt) is True
...
def test_custom_window():
    ...
    dt = datetime(2025, 1, 10, 13, 38, 0, tzinfo=timezone.utc)  # 8 Min nach NFP
